...
This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app). A paystack payment gateway that settles transactions in NGN currency has been integrated into the project and it works along with a  currency conversion api that converts the user's cart total in any currency to its approximate value in NGN.
